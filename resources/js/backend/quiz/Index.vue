        ...
        <b-card :footer="'Showing '+ data.data.length + ' data of '+ totalData"
            ...
            <b-card-header>
                <b-row>
                    ...
                    <p class="card-description">
                        Total categories <code>{{ totalData }}</code>
                    </p>
                    </b-col>
                    <b-col>
                    ...
                    <b-nav-item
                        ...
                        <span class="d-none d-md-block"><i class="ti-plus"></i> Add New Quiz</span>
            ...
            <b-table :items="data.data" :fields="fields" sticky-header="500px" head-variant="dark" outlined striped responsive="sm" v-if="$gate.isAuthorized()">
                ...
                <template #cell(status)="row">
                    <span v-if="row.item.daily">Daily Quiz</span> | <span v-if="row.item.display">Display</span> <br>
                    <span v-if="row.item.take_a_quiz">Take a Quiz</span> |  <span v-if="row.item.featured">Featured</span>
                </template>
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios.get("/admin/quiz?page=" + page).then(response => {
