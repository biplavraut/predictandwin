<template>
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        >
            <a class="navbar-brand brand-logo mr-5" href="/backend"
                ><img :src="'/logo/logo.png'" style="height: auto !important;" class="mr-2" alt="logo"
            /></a>
            <a class="navbar-brand brand-logo-mini" href="/backend"
                ><img :src="'/logo/logo.png'" style="height: auto !important;"  alt="logo"
            /></a>
        </div>
        <div
        ...
        >
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item nav-profile dropdown">
                    ...
                    >
                        <img
                            :src="'/storage/images/admin/super-admin/'+user.image"
                            alt="profile"
                        />
                    </a>
                    <div
